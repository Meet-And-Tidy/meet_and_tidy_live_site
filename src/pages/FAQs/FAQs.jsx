const FAQs = () => {
  return (
    <div className="container mx-auto mt-28 px-5 flex ">
      <div className="text-gray-100 py-32 mb-16	 min-h-screen">
        <div className="container flex flex-col justify-center align-center p-4 mx-auto md:p-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Frequently Asked Questions</h2>
            <p className="mt-6 text-lg leading-8 text-gray-600">Et labore commodo nulla aliqua proident mollit ullamco exercitation tempor.</p>
          </div>
